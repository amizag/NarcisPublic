...
## PID
pid1 = PID(-0.01, -0.05, 0, setpoint=0)
...
while True:
    ...
    if len(faces) == 0:
        ...
        if NoFaceCount == 50:
            Move_mirror_high(0, MaxArmHeight,   0,  0, 0.2)
            time.sleep(1)
    else:
        NoFaceCount = 0
        # print("Face Detected")
...
##################################################################################################
        ...
        ErrorDegBeta = (1 * z * 120/430)
        ErrorDegGama = (1 * t *  60/240)
        
        DeltaBetaPID = pid1(ErrorDegBeta)
        DeltaGamaPID = pid2(ErrorDegGama)
        
        Array1.append(DeltaBetaPID)
...
#         AbsPositionGama = ActualPositionGama - deltaGama;
        ...
        # print(DeltaBetaPID,AbsPositionBeta,ActualPositionBeta)
        # DeltaBetaPID = 0
